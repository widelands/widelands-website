...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('pybb_forum_moderators', (
            ...
            ('forum', models.ForeignKey(orm['pybb.forum'], null=False, on_delete=models.CASCADE)),
            ('user', models.ForeignKey(orm['auth.user'], null=False, on_delete=models.CASCADE))
        ))
        ...
        db.create_table('pybb_topic_subscribers', (
            ('id', models.AutoField(verbose_name='ID',
                                    primary_key=True, auto_created=True)),
            ('topic', models.ForeignKey(orm['pybb.topic'], null=False, on_delete=models.CASCADE)),
            ('user', models.ForeignKey(orm['auth.user'], null=False, on_delete=models.CASCADE))
        ))
