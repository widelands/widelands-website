        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "summary",
                    models.CharField(
                        max_length=150, null=True, verbose_name="Summary", blank=True
                    ),
                ),
                (
                    "markup",
                ...
                (
                    ...
                    models.GenericIPAddressField(
                        null=True,
                        verbose_name="IP Address of the Article Creator",
                        blank=True,
                    ),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "old_title",
                    models.CharField(
                        max_length=50, verbose_name="Old Title", blank=True
                    ),
                ),
                (
                    "old_markup",
                ...
                (
                    "content_diff",
                    models.TextField(verbose_name="Content Patch", blank=True),
                ),
                (
                    "comment",
                    models.TextField(verbose_name="Editor comment", blank=True),
                ),
                (
                    "modified",
