    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('size', models.CharField(max_length=1, choices=[(b'S', b'small'), (b'M', b'medium'), (b'B', b'big'), (b'I', b'mine'), (b'P', b'port'), (b'H', b'headquarters')])),
                ('type', models.CharField(max_length=1, choices=[(b'P', b'productionsite'), (b'W', b'warehouse'), (b'M', b'militarysite'), (b'T', b'trainingsite')])),
