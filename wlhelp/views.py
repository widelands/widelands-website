...
def buildings(request, tribe="barbarians"):
    ...
    # All headquarters
    buildings["headquarters"] = Building.objects.filter(size="H", tribe=t).order_by(
        "displayname"
    )
