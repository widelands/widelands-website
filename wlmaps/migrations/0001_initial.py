    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "nr_players",
                    models.PositiveIntegerField(verbose_name=b"Max Players"),
                ),
                ...
                (
                    "file",
                    models.FileField(upload_to=b"wlmaps/maps", verbose_name=b"Mapfile"),
                ),
                ("world_name", models.CharField(max_length=50)),
                ("pub_date", models.DateTimeField(default=datetime.datetime.now)),
                (
                    "uploader_comment",
                    models.TextField(verbose_name=b"Uploader comment", blank=True),
                ),
                (
                    "nr_downloads",
                ...
                (
                    "rating_votes",
                    models.PositiveIntegerField(default=0, editable=False, blank=True),
                ),
                (
                    "rating_score",
