...
class TestCategory(DjangoTest):
    ...
    def test_addCategoryWhichExists_exceptFail(self):
        ...
        self.assertRaises(
            IntegrityError, Category.objects.create, name="A NEW Revision"
        )
...
class TestScreenshot(_ScreenshotBase):
    def setUp(self):
        ...
        self.i = Screenshot.objects.create(
            name="First Test", category=self.c, screenshot=img, comment="This rockz!"
        )
